...
def start(update, context):
    context.bot.send_sticker(update.effective_chat.id,'CAACAgIAAxkBAAIJ4GNERpoymbinesH8SnZ7tnRNaxDBAALlDAACqFTBSPxg3fTAdQLKKgQ')
...
def tel(update, context):
    ...
    while True:
      try:
       ...
       context.bot.send_sticker(update.effective_chat.id,'CAACAgIAAxkBAAIJ42NERtCDD2eJ4u6Wz6M9DOnSVH17AAIuDgACmrDJSKj-4tAbP_yqKgQ')
       update.message.reply_text(
...
def cancel(update, context):
    context.bot.send_sticker(update.effective_chat.id,'CAACAgIAAxkBAAIJ5mNERw7-6gFaZjKkNu3QTLnP5NOrAAJcCwACuIaoS7EiwXXOZWHIKgQ')
    update.message.reply_text(
